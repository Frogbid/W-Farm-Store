                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center"><img class="media-object round-media" src="../<?php echo $row['catimg']; ?>" alt="Generic placeholder image" style="height: 75px;"></td>
