               ...
               <div class="row">
                  <div class="col-lg-2 col-md-2 col-sm-12 col-12">
                     ...
                     <ul class="list-group">
                        <?php
                        $id = $_GET['id'];
                        $query = "SELECT subcategory.id as sid,subcategory.name,subcategory.cat_id,category.id as cid FROM category,subcategory WHERE category.id = subcategory.cat_id AND category.id = '$id'";
