                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    <div class="product-image">
                                        <a><img src="<?php echo $row['pimg']; ?>" alt="Image 1"
                                    ...
                                    <form action="" class="form-submit">
                                            ...
                                            if (mysqli_num_rows($data) > 0) {
                                                while ($rows = mysqli_fetch_assoc($data)) {
                                                    ...
                                                    <div class="fomr-group">
                                                        ...
                                                        <select name="pgms" class="form-control" id="ptype"
                                                            ...
                                                            foreach ($values as $value) {
                                                                ?>
                                                                <option class="ptype"
                                                                        value="<?php echo $count; ?>"><?php echo $value; ?></option>
                                                                <?php
                                                                $count = $count + 1;
                                                            }
                                                            ?>
                                                ...
                                                if (mysqli_num_rows($data) > 0) {
                                                    while ($rows = mysqli_fetch_assoc($data)) {
                                                        ...
                                                        foreach ($values as $value) {
                                                            ?>
                                                            <option class="pprice"
                                                                    value="<?php echo $cnt; ?>"><?php echo $value; ?></option>
                                                            <?php
                                                            $cnt = $cnt + 1;
                                                        }
                                                        ?>
                                       ...
                                       <span class="input-group-btn">
                                          <button type="button" class="quantity-left-minus btn btn-danger btn-number"
                                             ...
                                             <span class="glyphicon glyphicon-minus"><i class="fa fa-minus"
                                                                                        aria-hidden="true"></i></span>
                                          </button>
                                       </span>
                                                <input type="text" id="quantity" name="quantity"
                                                       class="form-control qty" value="1" minlength="1" maxlength="10">
                                                <span class="input-group-btn">
                                          <button type="button" class="quantity-right-plus btn btn-success btn-number"
                                                  data-type="plus" data-field="">
                                             <span class="glyphicon glyphicon-plus"><i class="fa fa-plus"
                                                                                       aria-hidden="true"></i></span>
                                          </button>
                                       </span>
                                            </div>
                    ...
                    while ($row = mysqli_fetch_assoc($data)) {
                        ...
                        <div class="oc-item">
                            <div class="product iproduct clearfix">
                                <div class="product-image">
                                    <a href="viewProduct.php?id=<?php echo $row["id"]; ?>&cid=<?php echo $row["cid"]; ?>"><img
                                                src="<?php echo $row['pimg']; ?>" alt="Round Neck T-shirts"
                                                style="width:200px;height:200px;"></a>
                                    <a href="viewProduct.php?id=<?php echo $row["id"]; ?>&cid=<?php echo $row["cid"]; ?>"><img
                                                src="<?php echo $row['pimg']; ?>" alt="Round Neck T-shirts"
                                                style="width:200px;height:200px;"></a>
                                    <div class="sale-flash" style="background-color: #FED700;color:black;">
                                        ...
                                        if ($row['discount'] > 0) {
                                            ?>
                                            <span class="lead"><span class="badge badge-success"
                                                                     style="color:#fff;"><?php echo $row['discount'] . ' % Off' ?></span></span>
                                            <?php
                                        } else {
                                            ?>
                                ...
                                <div class="product-desc">
                                    <div class="product-title mb-1">
                                        ...
                                        <a href="viewProduct.php?id=<?php echo $row["id"]; ?>&cid=<?php echo $row["cid"]; ?>"
                                           class="btn btn-block text-dark mt-1" style="background-color: #28a745;"><b><i
                                                        class="icon-shopping-cart"></i>&nbsp;Add to cart&nbsp;<i
                                                        class="icon-shopping-cart"></i></b></a>
                                    </div>
                                </div>
                            </div>
                        </div>
